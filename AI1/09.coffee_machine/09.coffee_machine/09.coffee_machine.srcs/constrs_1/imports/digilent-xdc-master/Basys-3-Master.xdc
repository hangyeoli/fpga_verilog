...
## Buttons (mapped for current design)
set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports {coin}]
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports {return_coin_btn}]
set_property -dict { PACKAGE_PIN T17   IOSTANDARD LVCMOS33 } [get_ports {coffee_btn}]
